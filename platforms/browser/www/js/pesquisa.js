...
function onLoad(){
	...
	if(controle == "c") {
		...
		grupos(codProdcombos, descProdcombos, precoProdcombos);
		storage.removeItem("controle");
	} else if(controle == "s") {
		toastInfo("O item: Salgados foi selecionado!");
		grupos(codProdsalgs, descProdsalgs, precoProdsalgs);
		storage.removeItem("controle");
	} else if(controle == "b") {
		toastInfo("O item: Bebidas foi selecionado!");
		grupos(codProdbebs, descProdbebs, precoProdbebs);
		storage.removeItem("controle");
	} else if(controle == "l") {
		toastInfo("O item: Lanches foi selecionado!"); 
		grupos(codProdlanches, descProdlanches, precoProdlanches);
		storage.removeItem("controle");
	} else if(controle == "sp") {
		toastInfo("O item: Sopas foi selecionado!");
		grupos(codProdsopas, descProdsopas, precoProdsopas);
		storage.removeItem("controle");
	} else if(controle == "") {
		pesquisar();
		storage.removeItem("controle");
